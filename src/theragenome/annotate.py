...
#
# theragenome is free software: you can redistribute it and/or modify it under the terms of the GNU Affero General
# Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any
# later version.
#
# theragenome is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied
# warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU Affero General Public License for more
# details.
#
# You should have received a copy of the GNU Affero General Public License along with theragenome. If not, see
...
class Annotate:
    """
    A class to perform machine annotation on the "theragenome_db" MySQL database, with the help of the NER model
    ...
    :param query_table: name of the query or source table used to extract data for annotation, defaults to "theragenome"
    :type query_table: str, optional
    """

    def __init__(self, password, input_model_path="ner_model", query_table="theragenome"):
        """
        Constructor method
        """
        self.output_table = ""
        ...
        self.mydb = mysql.connector.connect(host="localhost", user="root", password=password, database="theragenome_db")
    ...
    def update_table_list(self):
        """
        Updates the list of tables to the ones defined in the MySQL "theragenome_db" database
        """
    ...
    def create_table(self, output_name="theragenome_ann"):
        """
        Creates the annotation output table in the MySQL "theragenome_db" database

        :param output_name: name of the annotation output table, defaults to "theragenome_ann"
    ...
    def annotate(self, output_name="theragenome_ann"):
        """
        Performs machine annotation on the abstracts defined in the query or source table of the "theragenome_db"
