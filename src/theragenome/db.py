...
class SqlDb:
    ...
    :param database: name of the working MySQL database, defaults to "theragenome_db"
    ...
    def create_table(self, name="theragenome"):
        """
        Creates MySQL table.

        :param name: name to your created table, defaults to "theragenome"
    ...
    def fill_table(self, name="theragenome"):
        """
        Fills a MySQL table with the data from the filtered .parquet file(s).

        :param name: name of the table to be filled, defaults to "theragenome"
        :type name: str, optional
        """
