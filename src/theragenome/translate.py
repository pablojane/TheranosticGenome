...
class Translate:
    """
    A class to perform protein to gene translation using as input an Excel file exported from the theragenome MySQL
    database
    """
    ...
    def translate(self, input_excel_path=".", output_excel_path="."):
        """
        Performs protein to gene translation using as input an Excel file exported from the theragenome MySQL database.
        ...
        :param input_excel_path: path to the Excel file exported from the theragenome sql database, defaults to "."
