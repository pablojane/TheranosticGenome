...
# by the Theranostic Genome team and are included in the models/ folder of the TheranosticGenome repository.     #
...
parser.download(ftp_list=['ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline/pubmed24n0001.xml.gz',
                          'ftp://ftp.ncbi.nlm.nih.gov/pubmed/baseline/pubmed24n0002.xml.gz'])
